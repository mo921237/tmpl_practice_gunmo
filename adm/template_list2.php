...
// else {
//     alert("nm 값 없음");
        $sql2 = " select * from template";  //쿼리문 작성
//         }
...
<div>
	<table>
		<tr>
			<td>번호<td>템플릿명<td>템플릿타입<td>템플릿컨텐츠<td>삭제
		</tr>
		<?php
...
// 		    break;
		      echo "<tr>";
		      echo "<td>".$aa['tmpl_no']."<td>".$aa['tmpl_nm']."<td>".$aa['tmpl_type']."<td>".$aa['tmpl_cont']."<td><a href='javascript:deleteTmpl(\"".$aa['tmpl_no']."\");'>삭제</a>";
		      echo "</tr>";
		}?>
	</table>
</div>
