...
<nav id="footer" class="navbar fixed-bottom navbar-light bg-light">
    <div class="d-flex align-self-center">
        Copyright &copy; <?php echo $_SERVER['HTTP_HOST']; ?>. All rights reserved. <span class="d-none d-md-inline"> <?php echo $print_version; ?></span>
    </div>
    <button type="button" class="scroll_top"><i class="fa fa-chevron-up" aria-hidden="true"></i></button>
</nav>
