...
<div class="basic-menu-wrap-v3 js-offcanvas" data-offcanvas-options='{"modifiers":"left,push"}' id="off-canvas-left-push" role="complementary">
                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    ...
                    <li class="nav-parent nav-item" id="headingOne<?php echo $i ?>">
                        ...
                        for ($k = 0; $row2 = sql_fetch_array($result2); $k++) {
                            ...
                            echo "<li class='sub-list'><a href='{$row2['me_link']}' target='_{$row2['me_target']}'> &middot; {$row2['me_name']}</a></li>" . PHP_EOL;
                        }
