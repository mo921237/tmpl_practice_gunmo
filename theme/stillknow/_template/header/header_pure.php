 ...
 * 해더 메뉴 - Pure
 */
add_stylesheet('<link rel="stylesheet" href="' . G5_THEME_CSS_URL . '/header_pure.css">', 0);
?>
<!-- 헤더 시작 -->
<header id="header" class="header header_pure head-wrapper">
	<div id="basic-header-wrap" class="basic-primary-header">
		...
		<div class="container pc-main-menu">
			...
			<div id="logo">
				<!-- PC LOGO -->
				<a href="<?php echo G5_URL ?>" class="site-logo"><img src="<?php echo G5_THEME_URL ?>/img/logo-b.png" class="logo" alt="Logo"></a>
			</div>
			<!--//로고끝 -->
...
<script>
	$(function() {
		...
		new ScrollMagic.Scene({
			...
			.setClassToggle("body", "sticky_header")
			.addTo(controller);
		// Smooth scrolling
