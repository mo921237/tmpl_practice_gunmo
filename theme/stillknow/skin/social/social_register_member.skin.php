...
add_stylesheet('<link rel="stylesheet" href="' . G5_THEME_CSS_URL . '/member.css">', 5);
add_stylesheet('<link rel="stylesheet" href="' . G5_JS_URL . '/remodal/remodal.css">', 11);
add_stylesheet('<link rel="stylesheet" href="' . G5_JS_URL . '/remodal/remodal-default-theme.css">', 12);
add_stylesheet('<link rel="stylesheet" href="' . G5_THEME_CSS_URL . '/social-login.css">', 20);
    ...
    <div class="mbskin" id="register_member">
        ...
        <form id="fregisterform" name="fregisterform" action="<?php echo $register_action_url; ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="btn_confirm">
                <input type="submit" value="회원가입" id="btn_submit" class="btn_submit btn btn-primary" accesskey="s">
                <a href="<?php echo G5_URL ?>" class="btn_cancel btn btn-danger">취소</a>
            </div>
        </form>
        <!-- 새로가입 끝 -->
        ...
        <div class="member_connect">
            ...
            <button type="button" class="connect-opener btn-txt btn btn-primary" data-remodal-target="modal">
                기존 계정에 연결하기
            ...
            <div class="connect-fg">
                <form method="post" action="<?php echo $login_action_url ?>" onsubmit="return social_obj.flogin_submit(this);">
                    ...
                    <div id="login_fs">
                        ...
                        <span class="lg_id"><input type="text" name="mb_id" id="login_id" class="frm_input required form-control" size="20" maxLength="20" ></span>
                        <label for="login_pw" class="login_pw">비밀번호<strong class="sound_only"> 필수</strong></label>
                        <span class="lg_pw"><input type="password" name="mb_password" id="login_pw" class="frm_input form-control required" size="20" maxLength="20"></span>
                        <br>
                        <input type="submit" value="연결하기" class="login_submit btn btn-primary">
                    </div>
