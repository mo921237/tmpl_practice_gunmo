...
add_stylesheet('<link rel="stylesheet" href="' . G5_THEME_CSS_URL . '/board-youtube.css">', 10);
                ...
                <div class="board-share-wrap text-right">
                    <ul class='board-share'>
                        <li class='d-inline-block'>
                            <!-- Share on Twitter -->
                            <a href="#" onclick="javascript:window.open('https://twitter.com/intent/tweet?text=[%EA%B3%B5%EC%9C%A0]%20' + encodeURIComponent(document.URL) + '%20-%20' + encodeURIComponent(document.title), 'twittersharedialog', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600'); return false;" alt="Share on Twitter"><img src="<?php echo G5_THEME_IMG_URL ?>/Twitter.png"></a>
                        </li>
                        <li class='d-inline-block'>
                            <!-- Share on Facebook -->
                            <a href="#" onclick="javascript:window.open('https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(document.URL) + '&amp;t=' + encodeURIComponent(document.title), 'facebooksharedialog', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600'); return false;" alt="Share on Facebook"> <img src="<?php echo G5_THEME_IMG_URL ?>/Facebook.png"></a>
                        </li>
                        <li class='d-inline-block'>
                            <!-- Share on Google+ -->
                            <a href="#" onclick="javascript:window.open('https://plus.google.com/share?url=' + encodeURIComponent(document.URL), 'googleplussharedialog', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=350,width=600'); return false;" alt="Share on Google+"> <img src="<?php echo G5_THEME_IMG_URL ?>/Google_Plus.png"></a>
                        </li>
                        <li class='d-inline-block'>
                            <!-- Share on Kakaostory -->
                            <a href="#" onclick="javascript:window.open('https://story.kakao.com/s/share?url=' + encodeURIComponent(document.URL), 'kakaostorysharedialog', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=600'); return false;" alt="Share on kakaostory"> <img src="<?php echo G5_THEME_IMG_URL ?>/Kakao_Story.png"></a>
                        </li>
                        <li class='d-inline-block'>
                            <!-- Share on Naver -->
                            <a href="#" onclick="javascript:window.open('http://share.naver.com/web/shareView.nhn?url=' + encodeURIComponent(document.URL) + '&amp;title=' + encodeURIComponent(document.title), 'naversharedialog', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600'); return false;" alt="Share on Naver"><img src="<?php echo G5_THEME_IMG_URL ?>/Naver.png"></a>
                        </li>
                    </ul>
                </div>
            </div>
...
<div class="board-view-wrap container">
    ...
    <div id="bo_v_top" class="view-buttons">
        ...
        <div class="btn-group pull-left">
            <?php if ($copy_href) { ?><a href="<?php echo $copy_href ?>" class="btn btn-sm btn-secondary" onclick="board_move(this.href);
                        return false;"><i class="fa fa-files-o" aria-hidden="true"></i> <span>복사</span></a><?php } ?>
    ...
    <article id="bo_v" style="width:<?php echo $width; ?>">
        ...
        <section id="bo_v_atc" class="view-contents">
             ...
             */
            // link #1
            if (isset($view['link']['1']) && $view['link']['1'] != NULL) {
                if (strstr($view['link']['1'], 'youtube.com')) {
                    parse_str(parse_url($view['link']['1'], PHP_URL_QUERY), $my_arr);
                    $youtube1 = $my_arr['v'];
                } elseif (strstr($view['link']['1'], 'youtu.be')) {
                    preg_match("/youtu.be\/([^&]+)/", $view['link']['1'], $my_arr);
                    $youtube1 = $my_arr['1'];
                }
                ?>
                <div class="plyr__video-embed" id="player_link1">
                    <iframe src="https://www.youtube.com/embed/<?php echo $youtube1 ?>?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1" allowfullscreen allowtransparency allow="autoplay"></iframe>
                </div>
                <br/>
                <?php
            }
            // link #2
            if (isset($view['link']['2']) && $view['link']['2'] != NULL) {
                if (strstr($view['link']['2'], 'youtube.com')) {
                    parse_str(parse_url($view['link']['2'], PHP_URL_QUERY), $my_arr2);
                    $youtube2 = $my_arr2['v'];
                } elseif (strstr($view['link']['2'], 'youtu.be')) {
                    preg_match("/youtu.be\/([^&]+)/", $view['link']['2'], $my_arr2);
                    $youtube2 = $my_arr2['1'];
                }
                ?>
                <div class="plyr__video-embed" id="player_link2">
                    <iframe src="https://www.youtube.com/embed/<?php echo $youtube2 ?>?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1" allowfullscreen allowtransparency allow="autoplay"></iframe>
                </div>
                <br/>
                <?php
            }
            ...
            if ($v_img_count) {
                ...
                for ($i = 0; $i <= count($view['file']); $i++) {
                    if ($view['file'][$i]['view']) {
                        if (strstr($view['file'][$i]['file'], 'youtube')) {
                            continue;
                        }
            ...
            <?php if ($scrap_href || $good_href || $nogood_href) { ?>                
                <div id="bo_v_act" class="btn-group btn-group-sm view-contents-button d-flex justify-content-center">
                    <?php if ($scrap_href) { ?><a href="<?php echo $scrap_href; ?>" target="_blank" class="btn btn-secondary" onclick="win_scrap(this.href);
                                    return false;"><i class="fa fa-bookmark" aria-hidden="true"></i> <span>스크랩</span></a><?php } ?>
                       <?php if ($good_href) { ?>
                        <a href="<?php echo $good_href . '&amp;' . $qstr ?>" id="good_button" class="btn btn-secondary"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> <span>추천</span> <?php echo number_format($view['wr_good']) ?></a>
                        <span class="bo_v_act_gng">
                            <b id="bo_v_act_good"></b>
                        </span>
                    <?php } ?>
                    <?php if ($nogood_href) { ?>
                        <a href="<?php echo $nogood_href . '&amp;' . $qstr ?>" id="nogood_button" class="btn btn-secondary"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i> <span>비추천</span> <?php echo number_format($view['wr_nogood']) ?></a>
                        <span class="bo_v_act_gng">
                ...
                if ($board['bo_use_good'] || $board['bo_use_nogood']) {
                    ?>
                    <div id="bo_v_act" class="btn-group btn-group-sm view-contents-button d-flex justify-content-center">
                        <?php if ($board['bo_use_good']) { ?><a href="#askgood" class="btn btn-secondary"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> <span>추천</span> <strong><?php echo number_format($view['wr_good']) ?></strong></a><?php } ?>
                        <?php if ($board['bo_use_nogood']) { ?><a href="#asknogood" class="btn btn-secondary"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i> <span>비추천</span> <strong><?php echo number_format($view['wr_nogood']) ?></strong></a><?php } ?>
                    </div>
                    <?php
                }
            }
