                ...
                <table class="table table-hover">
                    ...
                    <thead class="thead-default">
                        <tr>
                            ...
                            <th class="co-5"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>날짜</a></th>
                            <th class="co-6"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>조회</a></th>
                            <?php if ($is_good) { ?>
                                <th class="co-7"><?php echo subject_sort_link('wr_good', $qstr2, 1) ?>추천</a></th>
                            <?php } ?>
                            <?php if ($is_nogood) { ?>
                                <th class="co-8"><?php echo subject_sort_link('wr_nogood', $qstr2, 1) ?>비추천</a></th>
                            <?php } ?>
                        </tr>
                    </thead>
                    <tbody>
                                ...
                                <td class="td_subject co-3">
                                    ...
                                    <a href="<?php echo $list[$i]['href'] ?>">
                                        ...
                                        <?php if ($list[$i]['comment_cnt']) { ?>
                                            ...
                                            <span class="badge badge-medium-light badge-cycle"><?php echo $list[$i]['comment_cnt']; ?></span>
                                    ...
                                    <div class="sm-show">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><?php echo $list[$i]['datetime2'] ?></li>
                                            <li class="breadcrumb-item">Hit:<?php echo $list[$i]['wr_hit'] ?></li>
                                            <?php if ($is_good) { ?><li class="breadcrumb-item">추천:<?php echo $list[$i]['wr_good'] ?></li><?php } ?>
                                            <?php if ($is_nogood) { ?><li class="breadcrumb-item">비추천:<?php echo $list[$i]['wr_nogood'] ?></li><?php } ?>
                                        </ol>
                                    </div>
                                </td>
                                <td class="td_name sv_use co-4"><?php echo $list[$i]['name'] ?></td>
                                <td class="td_date co-5"><?php echo $list[$i]['datetime2'] ?></td>
                                <td class="td_num co-6"><?php echo $list[$i]['wr_hit'] ?></td>
                                <?php if ($is_good) { ?><td class="td_num co-7"><?php echo $list[$i]['wr_good'] ?></td><?php } ?>
                                <?php if ($is_nogood) { ?><td class="td_num co-8"><?php echo $list[$i]['wr_nogood'] ?></td><?php } ?>
                            </tr>
                        <?php } ?>
                        <?php
                        if (count($list) == 0) {
                    ...
                    <div class="bo_fx">
                        ...
                        <?php if ($list_href || $write_href) { ?>
                            <div class="pull-right">
                                ...
                                <?php if ($write_href) { ?><a href="<?php echo $write_href ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i> 글쓰기</a><?php } ?>
                            </div>
                        <?php } ?>
                    </div>
                </div>
