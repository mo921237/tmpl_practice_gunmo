...
<section id="bo_v_ans" class="qa-reply">
    <?php
        ...
        <form name="fanswer" method="post" action="./qawrite_update.php" onsubmit="return fwrite_submit(this);" autocomplete="off">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input type="text" name="qa_subject" value="" id="qa_subject" required class="form-control required" size="50" maxlength="255">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-footer">
                <input type="submit" value="답변쓰기" id="btn_submit" accesskey="s" class="btn btn-primary">
            </div>
        </form>
