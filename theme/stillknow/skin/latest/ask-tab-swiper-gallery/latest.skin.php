...
<div class="latest-tab-gallery-wrap latest-content swiper-basic latest-equal-item">
    <div class="gallery-grid row">
        ...
        <?php } ?>
        <?php if (count($list) == 0) { ?>
            <div class="empty-latest-article col-sm-12">게시물이 없습니다.</div>
        <?php } else { ?>
            <div class="more-view col-sm-12">
