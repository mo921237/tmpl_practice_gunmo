...
$ask_img['width'] = 640;
$ask_img['height'] = 360;
add_stylesheet('<link rel="stylesheet" href="' . G5_THEME_CSS_URL . '/latest-portfolio-shuffle.css">', 100);
...
?>
<div class="category-list-items" data-toggle="buttons">
...
<div class="latest-portfolio-shuffle-wrap <?php echo $custom_class ?>">
            ...
            <div class='col-6 col-sm-12 col-md-6 col-lg-4 image-item<?php echo $bo_table ?> my-sizer-element<?php echo $bo_table ?>' data-groups='["<?php echo $list[$i]['ca_name']; ?>"]'>
                <div class='aspect aspect--16x9'>
                    <div class="aspect__inner">
                        ...
                        <a href='<?php echo $list[$i]['href'] ?>' class="ss-subject">
