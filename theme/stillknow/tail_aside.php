...
if (_INDEX_ !== true && _INDEX_SUBPAGE_ !== true) {?>
    <!-- 서브페이지 및 그누보드 페이지용 -->
        </div><!--//.right_contents-->
    </div><!--//.row-->
</div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-3">
                <ul class="social-bookmark">
                    ...
                    <li>
                        <a href="http://themeb2.asktheme.net/theme/asktheme_b2/contact_us.php" class="icon-contactus"><i class="fa fa-envelope fa-2x" aria-hidden="true"></i></a>
                    </li>
                </ul>
            </div>
        </div>
