    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-3 col-lg-2 tail-login-wrap">
                <a href="<?php echo G5_URL ?>" class="tail-logo"><img src="<?php echo G5_THEME_URL ?>/img/logo.png" alt="Logo" style="width:180px;"></a>
            </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-3">
                <ul class="social-bookmark">
                    <li>
                        <a href="https://www.youtube.com/channel/UCDHW-2g40Vo7djzP_0ssgdA" target="_blank" class="icon-youtube"><i class="fa fa-youtube fa-2x" aria-hidden="true"></i></a>
                    </li>
                    <?
                    /*
                    <li>
