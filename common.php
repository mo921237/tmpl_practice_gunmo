...
#G5_MYSQL_PORT
//	$db = new $sql_db();
//	$connect_db = sql_connect(G5_MYSQL_HOST, G5_MYSQL_USER, G5_MYSQL_PASSWORD, G5_MYSQL_DB , G5_MYSQL_PORT) or die('MySQL Connect Error!!!');
$connect_db = sql_connect(G5_MYSQL_HOST, G5_MYSQL_USER, G5_MYSQL_PASSWORD, G5_MYSQL_DB, 3306 );
//   $connect_db = sql_connect(G5_MYSQL_HOST_PORT, G5_MYSQL_USER, G5_MYSQL_PASSWORD) or die('MySQL Connect Error!!!');
//	die("123");
//die($connect_db);
